...
space_kwargs = ["columns", "edge_tol", "row_tol", "column_tol"]
line_kwargs = [
    "process_background",
    "line_scale",
    "copy_text",
...
def validate_input(kwargs, flavor="line"):
    ...
    if flavor == "line":
        check_intersection(space_kwargs, kwargs)
    else:
        check_intersection(line_kwargs, kwargs)


def remove_extra(kwargs, flavor="line"):
    if flavor == "line":
        for key in kwargs.keys():
            if key in space_kwargs:
                kwargs.pop(key)
    else:
        for key in kwargs.keys():
